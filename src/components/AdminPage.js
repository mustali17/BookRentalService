...
const AdminPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F3E9D2] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-[#114B5F] mb-12">Admin Dashboard</h1>
          ...
          {adminCards.map((card, index) => (
            ...
            >
              <div className="p-6">
                ...
                <h2 className="text-xl font-semibold text-[#114B5F] text-center mb-2">{card.title}</h2>
                <p className="text-[#114B5F] text-center mb-4">{card.description}</p>
                <Link
                  to={card.link}
